=begin
    Description : Ruby file for sessions controller test
     ...
     **CHANGELOG**
     Ivan Balingit 1/31/18 - Inital Source Code and Generated all current code 
     Patricia Cajaljal 2/18/18 - Added License
